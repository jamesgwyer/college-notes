...
For this section I'm going to be referring to a Task 4a example from November 2022 about "Elanp Air". The data file given in this exam is about departures and arrivals to and from different airports. You can view all files for this below:
- [Brief](/esp/november-2022/Core%20Employer%20Set%20Project%20-Task4a%20-%20November%2022.pdf)
- [Data](/esp/november-2022/Task4a_data_November-22.csv)
- [Code.py](/esp/november-2022/Task4a_Elanp_dashboard_November-22.py)
- [Code.txt](/esp/november-2022/Task4a_Elanp_dashboard_November-22.txt)
...
**These next code snippets are relating to a different exam from June 2022** about a housing company called Newhaven as they were the only examples I could find. You can find the details on this section of that exam below:
- [Brief](/esp/june-2022/Core%20Employer%20Set%20Project%20-%20Task4A%20-%20Summer%202022.pdf)
- [Data](/esp/june-2022/Task4a_Data_Summer-2022.csv)
- [Code.py](/esp/june-2022/Task4a_Summer-2022_dashboard.py)
- [Code.txt](/esp/june-2022/Task4a_Summer-2022_dashboard.txt)
