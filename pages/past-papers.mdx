...
An archive of past papers that are (mostly) publicly available. You can download everything locally by going to [the repo on Github](https://github.com/6jtg/college-notes) and clicking the "Download ZIP" option in the "Code" dropdown.
...
- [Bean & Brew practice scenario](/past-papers/bean-and-brew-scenario)